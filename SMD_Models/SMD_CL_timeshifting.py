...
mixup = True
Ytr = None
augmentation_type = 'timeshifting'
...
for file in files:
  ...
  encoder, siamese_network, latent_train, latent_test = build_augdata_siamese_network(params, Xtr, Xte, Yte, dataset_name, inverter, Ytr=Ytr, mixup=mixup, augmentation_type=augmentation_type)
